...
public class ReadHandler extends BaseHandlerStd {
    ...
    private GetWorkgroupResponse readWorkgroup(final GetWorkgroupRequest awsRequest,
        ...
        try {
            ...
            logger.log("Handling read not found error waiting" + resourceNotFoundException.toString());
            throw resourceNotFoundException;
        } catch (Exception e) {
            logger.log("Handling read general error waiting" + e.toString());
            throw e;
        }
    }
    ...
    private ProgressEvent<ResourceModel, CallbackContext> readWorkgroupErrorHandler(final GetWorkgroupRequest awsRequest,
        ...
        logger.log("Handling read error" + exception.toString());
        if (exception instanceof ResourceNotFoundException) {
            ...
            logger.log("Handling read not found error waiting" + exception.toString());
            ...
            logger.log("Handling read internal error waiting" + exception.toString());
            return ProgressEvent.defaultFailureHandler(exception, HandlerErrorCode.InternalFailure);

        } else {
            logger.log("Handling read all error waiting" + exception.toString());
